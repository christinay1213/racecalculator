...
;
const metadata = {
    title: 'Relay Tracker - Live Race Dashboard',
    description: 'Real-time relay race tracker for 200-mile races. Track pace, fatigue, and estimated finish times for your team.',
    generator: 'v0.app',
    icons: {
        icon: [
            {
